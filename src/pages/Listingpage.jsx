...
export const ListingCard = ({ car, handleAddToCart, cartItems }) => {
  ...
  const isInCart =
    cartItems && cartItems[0] && cartItems[0].items
    ...
    <div className="max-w-sm rounded overflow-hidden shadow-lg m-4 bg-white">
      ...
      <div className="px-6 py-4">
        ...
        <ul className="list-none">
          ...
          <li className="mb-1 font-serif">
            Available To: {formattedAvailableTo}
          </li>
          <li className="mb-1 font-serif">
            <Link
        ...
        Add to Cart
            ...
            <button
              ...
              } text-white font-bold py-2 px-4 rounded mt-4 ml-4 focus:outline-none focus:shadow-outline`}
            >
